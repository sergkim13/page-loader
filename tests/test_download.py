...
expected_files_names = open(path_to_expected_files_names)
files_names_set = set(expected_files_names.read().split(',\n'))
...
def test_download():
    ...
    with requests_mock.Mocker() as m:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert set(os.listdir(result_html_files_path)) == path_to_expected_files_names
